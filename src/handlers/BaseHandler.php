...
{
    final public const MSG_INVALID_CLIENT_IPADDRESS = 'Invalid REMOTE_ADDR';
    final public const MSG_EMAIL_INVALID = 'Ungültige Mailadresse.';
    final public const MSG_HTTPURL_INVALID = 'Ungültige (http(s)) URL.';
    final public const MSG_EMAIL_BLACKLISTED = 'Mailadresse ist nicht zugelassen: ';

    final public const MSG_GENERIC_INVALID = 'Invalid or missing parameter value';
    final public const MSGCODE_BAD_PARAM = 400;
    final public const MSGCODE_AUTH_FAIL = 401;
    final public const MSGCODE_INTERNAL_ERROR = 500;
