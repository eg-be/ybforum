...
{
    public const PARAM_EMAIL_OR_NICK = 'resetpassword_email_or_nick';

    public const MSG_UNKNOWN_EMAIL_OR_NICK = 'Unbekannter Stammposter / Mailadresse';
    public const MSG_DUMMY_USER = 'Stammposter ist ein Dummy';
    public const MSG_USER_HAS_NO_EMAIL = 'Stammposter hat keine Mailadresse hinterlegt';
