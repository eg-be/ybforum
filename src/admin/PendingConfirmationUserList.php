...
{
    public const PARAM_PENDINGCONFIRM_ACTION = 'pendingconfirm_action';
    public const VALUE_CONFIRM = 'pendingconfirm_confirm';
    public const VALUE_DELETE = 'pendingconfirm_delete';
    public const VALUE_DELETE_AND_BLOCK = 'pendingconfirm_delete_and_block';

    public const PARAM_USERID = 'pendingconfirm_userid';
